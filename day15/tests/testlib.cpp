...
{
	auto part1_answer{ play_game_map_to_size_t(2020, sample_input) };
	CHECK(part1_answer == 436);
}

TEST_CASE("Part 1 answer with puzzle data should be 421")
{
	auto part1_answer{ play_game_map_to_size_t(2020, puzzle_input) };
	CHECK(part1_answer == 421);
}

TEST_CASE("Part 2 answer with sample data should be 175'594")
{
	auto part2_answer{ play_game_with_vectors(30'000'000, sample_input) };
	CHECK(part2_answer == 175'594);
}

TEST_CASE("Part 2 answer with puzzle data should be 436")
{
	auto part2_answer{ play_game_with_vectors(30'000'000, puzzle_input) };
